<%-- 
    Document   : size
    Created on : Jul 28, 2019, 10:57:26 PM
    Author     : Admin
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <br>
                                <a href="${pageContext.request.contextPath}/initNewSize.htm">Thêm mới</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="dataTable_wrapper" class="dataTable_wrapper dt-boostrap4">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <table class="table table-bordered" id="table_size">
                                                    <thead>
                                                        <tr>
                                                            <th>Size Id</th>
                                                            <th>Size Name</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listSize}" var="s">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="detailSize.htm?sizeId=${s.sizeId}" class="btn btn-success">Chi tiết</a>
                                                                    <a href="updateSize.htm?sizeId=${s.sizeId}" class="btn btn-primary">Sửa</a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
