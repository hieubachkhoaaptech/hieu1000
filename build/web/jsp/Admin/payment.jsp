                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3" style="background: #f8ccc8">
                                ...
                                <br>
                                <a href="${pageContext.request.contextPath}/initNewPayment.htm">Thêm mới</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table class="table table-bordered" id="table_catelog">
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${listPayment}" var="pay">
                                                        <tr>
                                                            <td>${pay.paymentId}</td>
                                                            <td>${pay.paymentName}</td>
                                                            <td>${pay.description}</td>
                                                            <td>
                                                                <a href="updatePayment.htm?paymentId=${pay.paymentId}" class="btn btn-primary">Sửa</a>
                                                                <a href="detailPayment.htm?paymentId=${pay.paymentId}" class="btn btn-success">Chi tiết</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                    </tbody>
