                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                            <div class="col-sm-12">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Mã màu sản phẩm:</label>
                                                <input type="text" value="${colo.colorId}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                            <div class="col-sm-12">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Tên màu sản phẩm:</label>
                                                <input type="text" value="${colo.colorName}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Ký hiệu</label>
                                                <input type="text" value="${colo.natation}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
