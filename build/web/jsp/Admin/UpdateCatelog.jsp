                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="x_panel">
                                    <div class="x_title" >
                                        <h5 style="margin-left: 30px"><b>Quản lí danh mục </b><small>  >> Sửa thông tin</small></h5>
                                        <div class="clearfix"></div>
                                        <f:form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/saveUpdateCatelog.htm"  method="POST" modelAttribute="upCatelog">
                                            <div class="form-group" style="margin-left: 170px; margin-top: 30px">
                                                <label for="inputCatelogId" class="col-sm-2 control-label" style=" font-weight: bold;">Mã sản phẩm:</label>
                                                <div class="col-sm-8" >
                                                    <f:input required="*" type="text" class="form-control" placeholder="Mã sản phẩm" path="catelogId" readOnly="true"/>
                                                </div>
                                            </div>
                                            <div class="form-group" style="margin-left: 170px; margin-top: 30px">
                                                <label for="inputCatelogName" class="col-sm-2 control-label" style=" font-weight: bold;">Tên sản phẩm:</label>
                                                <div class="col-sm-8" >
                                                    <f:input required="*" type="text" class="form-control"  placeholder="Tên sản phẩm" path="catelogName"/>
                                                </div>
                                            </div>
                                            <div class="form-group"  style="margin-left: 170px">
                                                ...
                                                <div class="col-sm-8">
                                                    <a href="#">
                                                        <img class="img border-gray" src="/ShopFashion/jsp/Admin/images/${upCatelog.images}" alt="..." ></a>
                                                        <f:input type="file" name="file" class="form-control" path="images"/>
                                                </div>
                                            </div>
                                            <div class="form-group"  style="margin-left: 170px">
