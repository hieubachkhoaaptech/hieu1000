                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3" style="background: #f8ccc8">
                                ...
                                <br>
                                <a href="<%=request.getContextPath()%>/initNewProvider.htm">Thêm mới</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table class="table table-bordered" id="table_provider">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listProvider}" var="p">
                                                            <tr>
                                                                <td>${p.providerId}</td>
                                                                ...
                                                                <td>${p.phone}</td>
                                                                <td>
                                                                    <a href="updateProvider.htm?providerId=${p.providerId}" class="btn btn-primary">Sửa</a>
                                                                    <a href="detailProvider.htm?providerId=${p.providerId}" class="btn btn-success">Chi tiết</a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
