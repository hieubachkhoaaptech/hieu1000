                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h4 style="margin-left: 50px">Xem chi tiết nhà cung cấp<small>  >> Detail Payment</small></h4>
                                        ...
                                        <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" value="${pay.paymentId}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                            <div class="col-sm-12">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Tên hình thức:</label>
                                                <input type="text" value="${pay.paymentName}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                ...
                                                <input type="text" value="${pay.description}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
