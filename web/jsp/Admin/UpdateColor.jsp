                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="x_panel">
                                    <div class="x_title" >
                                        <h5 style="margin-left: 30px"><b>Quản lí màu sản phẩm </b><small>  >> Sửa thông tin</small></h5>
                                        <div class="clearfix"></div>
                                        <f:form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/saveUpdateColor.htm" method="POST" modelAttribute="upColor">
                                            <div class="form-group" style="margin-left: 170px; margin-top: 30px">
                                                <label for="inputColorId" class="col-sm-2 control-label" style=" font-weight: bold;">Tên màu sản phẩm:</label>
                                                <div class="col-sm-8" >
                                                    <f:input required="*" type="text" class="form-control" id="colorId" placeholder="Mã màu sản phẩm" path="colorId" readOnly="true"/>
                                                </div>
                                            </div>
                                            <div class="form-group" style="margin-left: 170px; margin-top: 30px">
                                                <label for="inputColorName" class="col-sm-2 control-label" style=" font-weight: bold;">ký hiệu sản phẩm:</label>
                                                <div class="col-sm-8" >
                                                    <f:input required="*" type="text" class="form-control" id="colorName"  placeholder="Tên màu sản phẩm" path="colorName"/>
                                                </div>
                                            </div>
                                            <div class="form-group" style="margin-left: 170px; margin-top: 30px">
                                                <label for="inputCatelogName" class="col-sm-2 control-label" style=" font-weight: bold;">ký hiệu sản phẩm:</label>
                                                <div class="col-sm-8" >
                                                    <f:input required="*" type="text" class="form-control" id="natation"  placeholder="Ký hiệu sản phẩm" path="natation"/>
                                                </div>
                                            </div>
