                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h4 style="margin-left: 50px">Quản lí màu sản phẩm<small>  >> Thêm mới</small></h4>
                                        <div class="clearfix"></div>
                                        <f:form class="form-horizontal form-label-left" role="form"  action="${pageContext.request.contextPath}/insertColor.htm"  onsubmit="return validate()" modelAttribute="color">
                                            <div class="form-group message">
                                                ${message}
                                            </div>
                                            <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Tên màu sản phẩm:</label><span class="required">*</span>
                                                <div class="col-sm-12">
                                                    <f:input type="text" class="form-control" placeholder="Tên màu sản phẩm" path="colorName"/>
                                                </div>
                                            </div>
                                            <div class="form-group" style="margin-left: 250px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Ký hiệu sản phẩm:</label>
                                                <div class="col-sm-12" style="margin-right: 200px">
                                                    <f:input type="text" class="form-control" placeholder="ký hiệu" path="natation"/>
                                                </div>
                                            </div>
