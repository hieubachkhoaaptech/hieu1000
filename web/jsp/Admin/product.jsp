<%-- 
    Document   : Product
    Created on : Jul 22, 2019, 2:04:16 PM
    Author     : Admin
--%>
...
<html lang="en">
    ...
    <body id="page-top">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <br>
                                <a href="${pageContext.request.contextPath}/initNewProduct.htm">Thêm mới</a>
                            </div>
                            <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listProduct}" var="product">
                                                            <tr>
                                                                ...
                                                                <td>${product.catelogId.catelogName}</td>
                                                                <td>${product.providerId.providerName}</td>
                                                                <td>${product.quantity}</td>
                                                                <td>${product.price}</td>
                                                                <td><img title="${product.productName}" src="/ShopFashion/jsp/Admin/images/${product.images}" class="img-fix3" style="width:100px;height:100px;">
                                                                <td>${product.status?'Còn hàng':'hết hàng'}</td>
                                                                <td>${product.descriptions}</td>
                                                                <td>
                                                                    <a href="updateProduct.htm?productId=${product.productId}" class="ace-icon far fa-edit bigger-130">Sửa</a>
                                                                    <a href="detailProduct.htm?productId=${product.productId}" class="ace-icon fas fa-eye bigger-130">Chi tiết</a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
        ...
        <script src="/ShopFashion/jsp/Admin/demo/chart-pie-demo.js"></script>
