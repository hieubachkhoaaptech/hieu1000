                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3" style="background: #f8ccc8">
                                ...
                                <br>
                                <a href="${pageContext.request.contextPath}/initNewCatelog.htm">Thêm mới</a>
                            </div>
                            <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listCatelog}" var="c">
                                                            <tr>
                                                                <td>${c.catelogId}</td>
                                                                <td>${c.catelogName}</td>
                                                                <td><img title="${c.catelogName}" src="/ShopFashion/jsp/Admin/images/${c.images}">
                                                                </td>                                            
                                                                <td>${c.descriptions}</td>
                                                                <td>
                                                                    <a href="updateCatelog.htm?catelogId=${c.catelogId}" class="ace-icon far fa-edit bigger-130">Sửa</a>
                                                                    <a href="detailCatelog.htm?catelogId=${c.catelogId}" class="ace-icon fas fa-eye bigger-130">Chi tiết</a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
