                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h4 style="margin-left: 50px">Xem chi tiết khách hàng<small>  >> Detail Customer</small></h4>
                                        <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                            <div class="col-sm-12">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Mã:</label>
                                                <input type="text" value="${cus.customerId}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                            <div class="col-sm-12">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Tên:</label>
                                                <input type="text" value="${cus.customerName}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Tên đăng nhập:</label>
                                                <input type="text" value="${cus.userName}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Mật khẩu:</label>
                                                <input type="text" value="${cus.password}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Mô tả</label>
                                                <input type="text" value="${cus.address}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Mô tả</label>
                                                <input type="text" value="${cus.email}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Số điện thoại</label>
                                                <input type="text" value="${cus.phone}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Trạng thái</label>
                                                <input type="text" value="${cus.status}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
