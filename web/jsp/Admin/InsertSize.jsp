                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h4 style="margin-left: 50px">Quản lí size sản phẩm<small>  >> Thêm mới</small></h4>
                                        <div class="clearfix"></div>
                                        <f:form class="form-horizontal form-label-left" role="form"  action="${pageContext.request.contextPath}/insertSize.htm"  onsubmit="return validate()" modelAttribute="size">

                                            <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Tên size sản phẩm:</label>
                                                <div class="col-sm-12">
                                                    <f:input type="text" class="form-control" placeholder="Tên size sản phẩm" path="sizeName"/>
                                                </div>
                                            </div>
                                            <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Mô tả sản phẩm:</label>
                                                <div class="col-sm-12">
                                                    <f:input type="text" class="form-control" placeholder="Tên size sản phẩm" path="descriptions"/>
                                                </div>
                                            </div>
