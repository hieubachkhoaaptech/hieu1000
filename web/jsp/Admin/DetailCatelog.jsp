                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h4 style="margin-left: 50px">Xem chi tiết danh mục<small>  >> Detail Catelog</small></h4>
                                        <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                            <div class="col-sm-12">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Mã danh mục:</label>
                                                <input type="text" value="${ca.catelogId}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                            <div class="col-sm-12">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Tên danh mục:</label>
                                                <input type="text" value="${ca.catelogName}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                ...
                                                <img src="/ShopFashion/jsp/Admin/images/${ca.images}" width="300px"/>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-left: 250px">
                                            <div class="col-sm-12" style="margin-right: 200px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Mô tả</label>
                                                <input type="text" value="${ca.descriptions}" class="form-control" readonly="true"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
