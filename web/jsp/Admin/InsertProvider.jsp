                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h4 style="margin-left: 50px">Quản lí nhà cung cấp sản phẩm<small>  >> Thêm mới</small></h4>
                                        <div class="clearfix"></div>
                                        <f:form class="form-horizontal form-label-left" role="form"  action="${pageContext.request.contextPath}/insertProvider.htm" onsubmit="return validate()" modelAttribute="upProvider">

                                            <div class="form-group" style="margin-left: 250px; margin-top: 30px">
                                                <label for="inputProName" class="col-sm-10 control-label" style=" font-weight: bold;">Tên nhà cung cấp sản phẩm:</label>
                                                <div class="col-sm-12">
                                                    <f:input type="text" class="form-control" placeholder="Provider Name" path="providerName"/>
                                                </div>
                                            </div>
                                            <div class="form-group" style="margin-left: 250px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Địa chỉ</label>
                                                <div class="col-sm-12" style="margin-right: 200px">
                                                    <f:input type="text" class="form-control" placeholder="Address" path="address"/>
                                                </div>
                                            </div>
                                            <div class="form-group" style="margin-left: 250px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Hòm thư điện tử</label>
                                                <div class="col-sm-12" style="margin-right: 200px">
                                                    <f:input type="email" class="form-control" placeholder="Email" path="email"/>
                                                </div>
                                            </div>
                                            <div class="form-group" style="margin-left: 250px">
                                                <label for="inputImages" class="col-sm-10 control-label" style=" font-weight: bold">Phone</label>
                                                <div class="col-sm-12" style="margin-right: 200px">
                                                    <f:input type="text" class="form-control" placeholder="Phone" path="phone"/>
                                                </div>
                                            </div>
