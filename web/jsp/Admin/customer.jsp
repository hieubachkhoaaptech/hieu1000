                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="dataTable_wrapper" class="dataTable_wrapper dt-boostrap4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table class="table table-bordered" id="table_cus">
                                                    <thead>
                                                        <tr>
                                                            <th>Customer Id</th>
                                                            <th>Customer Name</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listCustomer}" var="cus">
                                                            <tr>
                                                                ...
                                                                <td><a class="btn btn-primary" href="${pageContext.request.contextPath}/detailCustomer.htm?customerId=${cus.customerId}">Xem</a>
                                                                    <a class="btn btn-warning" href="${pageContext.request.contextPath}/deleteCustomer.htm?customerId=${cus.customerId}" onclick=" return confirm('Bạn có chắc chắn muốn xóa không')">Xóa</a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
