...
@NamedQueries({
    ...
    , @NamedQuery(name = "OrderDetail.findByNote", query = "SELECT o FROM OrderDetail o WHERE o.note = :note")})
public class OrderDetail implements Serializable {
    ...
    public OrderDetail(Integer quantity, Product productId) {
        this.quantity = quantity;
        this.productId = productId;
    }

    public OrderDetail(Integer orderDetailId, Integer quantity) {
